...
/** Matches `GymLocation.address` / backend response (nested). */
...
export type CreateLocationFacility = {
  name: string;
  description: string;
};

/**
 * Single JSON body for `POST /api/gym-owner/locations`.
 * Address fields are flat (not nested). galleryImages are CDN URLs from `/api/upload/*`.
 */
export type CreateLocationPayload = {
  ...
  facilities: CreateLocationFacility[];
